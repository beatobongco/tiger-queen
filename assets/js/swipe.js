function addSwipeEvent(theDom, eventName, handleEvent) {
    ...
    theDom.addEventListener('touchend', function(e){
        ...
        // swipeUp
        if (moveVal<0 && moveAbsVal>THRESHOLD && eventName=="swipeUp") {
            // console.log("swipeUp");
            handleEvent();
        }

        // swipeDown
        if (moveVal>0 && moveAbsVal>THRESHOLD && eventName=="swipeDown") {
            // console.log("swipeDown");
            handleEvent();
        }

        // swipeLeft
        if (moveVal<0 && moveAbsVal>THRESHOLD && eventName=="swipeLeft") {
            // console.log("swipeLeft");
            handleEvent();
        }

        // swipeRight
        if (moveVal>0 && moveAbsVal>THRESHOLD && eventName=="swipeRight") {
